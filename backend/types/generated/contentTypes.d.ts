...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    pastor_name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    pastor_title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    ...
    section_ebenezer: Schema.Attribute.RichText;
    section_loins: Schema.Attribute.RichText;
    section_pharaoh: Schema.Attribute.RichText;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    hero_cta_text: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Browse Sermons'>;
    hero_cta_url: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 200;
      }> &
      Schema.Attribute.DefaultTo<'/sermons'>;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Pastoral blog posts and monthly write-ups';
...
export interface ApiSermonSermon extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Weekly sermon entries';
    displayName: 'Sermon';
    pluralName: 'sermons';
    singularName: 'sermon';
  };
